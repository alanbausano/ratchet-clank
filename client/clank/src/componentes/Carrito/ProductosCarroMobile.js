...
export default function ProductosCarroMobile({ carrito, dispatch, actualizar, setActualizar }){
  ...
  return (
    <>
     {carrito.map(producto => (
          <div key={producto.id} className="producto-container-m" >
            <div>
              <img src={producto.img} className='imagen-producto-m' alt=""/>
            </div>
            <div className="descripcion-container-m">
